...
if ( ! function_exists( 'firstframe_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function firstframe_get_filter_items( $params ) {
		...
		return apply_filters( 'firstframe_filter_get_filter_items', $items, $params );
	}
}
