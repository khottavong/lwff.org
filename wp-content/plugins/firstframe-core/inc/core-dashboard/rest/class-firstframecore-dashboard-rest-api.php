...
if ( ! class_exists( 'FirstFrameCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class FirstFrameCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'firstframe_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return FirstFrameCore_Dashboard_Rest_API
		 */
	...
	FirstFrameCore_Dashboard_Rest_API::get_instance();
}
