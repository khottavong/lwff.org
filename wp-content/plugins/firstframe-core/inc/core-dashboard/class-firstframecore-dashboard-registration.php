...
if ( class_exists( 'FirstFrameCore_Dashboard_Rest_API' ) ) {
	class FirstFrameCore_Dashboard_Registration extends FirstFrameCore_Dashboard_Rest_API {
		...
		/**
		 * @return FirstFrameCore_Dashboard_Rest_API|FirstFrameCore_Dashboard_Registration
		 */
		...
		public function register_rest_api_route() {
			...
			register_rest_route(
				...
				array(
					...
					'callback'            => array( FirstFrameCore_Dashboard::get_instance(), 'purchase_code_registration' ),
	...
	FirstFrameCore_Dashboard_Registration::get_instance();
}
