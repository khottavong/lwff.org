...
if ( ! class_exists( 'FirstFrameCore_Shortcodes' ) ) {
	class FirstFrameCore_Shortcodes {
		...
		/**
		 * @return FirstFrameCore_Shortcodes
		 */
		...
		function init() {
			...
			include_once FIRSTFRAME_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once FIRSTFRAME_CORE_SHORTCODES_PATH . '/class-firstframecore-shortcode.php';
			include_once FIRSTFRAME_CORE_SHORTCODES_PATH . '/class-firstframecore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'firstframe_core_filter_register_shortcodes', array() );
	...
	FirstFrameCore_Shortcodes::get_instance();
}
