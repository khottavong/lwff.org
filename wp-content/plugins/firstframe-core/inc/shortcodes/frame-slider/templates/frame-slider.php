<div class="qodef-frame-slider-holder swiper-container-horizontal">
	<div class="qodef-frame-slider-image">
		<img src="<?php echo esc_url( FIRSTFRAME_CORE_SHORTCODES_URL_PATH . '/frame-slider/assets/img/frame-slider.png' ); ?>" alt="<?php esc_attr_e( 'Frame slider phone', 'firstframe-core' ); ?>">
	</div>
