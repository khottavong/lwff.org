...
if ( $has_image ) {
	...
	?>
	<?php	firstframe_core_template_part( 'blog/shortcodes/blog-list', 'templates/post-info/custom-date', '', $params ); ?>
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo firstframe_core_get_list_shortcode_item_image( $image_dimension, $blog_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
	</div>
<?php } ?>
