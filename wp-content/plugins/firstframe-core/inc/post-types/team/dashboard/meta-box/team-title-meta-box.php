...
if ( ! function_exists( 'firstframe_core_add_team_title_meta_boxes' ) ) {
	/**
	 * Function that add title meta boxes for team module
	 */
	function firstframe_core_add_team_title_meta_boxes( $page, $has_single ) {
	...
	add_action( 'firstframe_core_action_after_team_meta_box_map', 'firstframe_core_add_team_title_meta_boxes', 10, 2 );
}
