...
if ( ! function_exists( 'firstframe_core_add_team_archive_list_options' ) ) {
	/**
	 * Function that add list options for team archive module
	 */
	function firstframe_core_add_team_archive_list_options( $tab ) {
		$list_item_layouts = apply_filters( 'firstframe_core_filter_team_list_layouts', array() );
		...
		if ( $tab ) {
			...
			if ( sizeof( $list_item_layouts ) > 1 ) {
				$tab->add_field_element(
					array(
						...
						'description'   => esc_html__( 'Choose layout for list item on archive page', 'firstframe-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose an appearance style for archive list', 'firstframe-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose number of columns for archive list', 'firstframe-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose horizontal space between items for archive list', 'firstframe-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 1367 and 1440 px for archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 1025 and 1366 px for archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 769 and 1024 px for archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 681 and 768 px for archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 481 and 680 px for archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 0 and 480 px for archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enable loop for slider display of archive list', 'firstframe-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enable autoplay for slider display of archive list', 'firstframe-core' ),
					'options'     => firstframe_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'  => array(
						'show' => array(
							'qodef_team_archive_behavior' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enter slider speed for slider display of archive list', 'firstframe-core' ),
					'dependency'  => array(
						'show' => array(
							'qodef_team_archive_behavior' => array(
								'values'        => 'slider',
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Enable navigation for slider display of archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Enable pagination for slider display of archive list', 'firstframe-core' ),
					'default_value' => '3',
					'options'       => firstframe_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose pagination type for archive list', 'firstframe-core' ),
	...
	add_action( 'firstframe_core_action_after_team_options_archive', 'firstframe_core_add_team_archive_list_options' );
}
