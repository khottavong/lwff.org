<?php
$styles = array();
if ( ! empty( $image_rounded_content_margin_top ) ) {
	$margin_top = qode_framework_string_ends_with_space_units( $image_rounded_content_margin_top ) ? $image_rounded_content_margin_top : intval( $image_rounded_content_margin_top ) . 'px';
