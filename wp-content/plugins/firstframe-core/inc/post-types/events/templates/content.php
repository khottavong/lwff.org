...
do_action( 'firstframe_core_action_before_events_content_holder' );
?>
<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( firstframe_core_get_page_grid_sidebar_classes() ); ?> <?php echo esc_attr( firstframe_core_get_grid_gutter_classes() ); ?>" role="main">
	<div class="qodef-grid-inner">
		...
		firstframe_core_template_part( 'post-types/events', 'templates/events', $template_slug );
...
do_action( 'firstframe_core_action_after_events_content_holder' );
?>
