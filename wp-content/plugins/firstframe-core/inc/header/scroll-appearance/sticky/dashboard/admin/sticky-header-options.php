...
if ( ! function_exists( 'firstframe_core_add_sticky_header_options' ) ) {
	/**
	 ...
	 */
	function firstframe_core_add_sticky_header_options( $page, $section ) {
	...
	add_action( 'firstframe_core_action_after_header_scroll_appearance_options_map', 'firstframe_core_add_sticky_header_options', 10, 2 );
}

if ( ! function_exists( 'firstframe_core_add_sticky_header_logo_options' ) ) {
	/**
	 ...
	 */
	function firstframe_core_add_sticky_header_logo_options( $page, $header_tab, $logo_image_section ) {
	...
	add_action( 'firstframe_core_action_after_header_logo_image_section_options_map', 'firstframe_core_add_sticky_header_logo_options', 10, 3 );
}

if ( ! function_exists( 'firstframe_core_add_sticky_header_logo_svg_options' ) ) {
	/**
	 * Function that add additional header logo options
	 *
	 * @param object $page
	 ...
	 */
	function firstframe_core_add_sticky_header_logo_svg_options( $page, $header_tab, $logo_svg_path_section ) {
	...
	add_action( 'firstframe_core_action_before_header_logo_svg_path_section_options_map', 'firstframe_core_add_sticky_header_logo_svg_options', 10, 3 );
}
