...
if ( ! function_exists( 'firstframe_core_add_divided_header_options' ) ) {
	/**
	 ...
	 */
	function firstframe_core_add_divided_header_options( $page, $general_header_tab ) {
	...
	add_action( 'firstframe_core_action_after_header_options_map', 'firstframe_core_add_divided_header_options', 10, 2 );
}
