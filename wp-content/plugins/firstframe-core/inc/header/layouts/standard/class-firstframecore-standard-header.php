...
class FirstFrameCore_Standard_Header extends FirstFrameCore_Header {
	...
	/**
	 * @return FirstFrameCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return firstframe_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
