...
if ( ! function_exists( 'firstframe_core_add_standard_header_options' ) ) {
	/**
	 ...
	 */
	function firstframe_core_add_standard_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'        => 'qodef_standard_header_section',
				'title'       => esc_html__( 'Standard Header', 'firstframe-core' ),
				'description' => esc_html__( 'Standard header settings', 'firstframe-core' ),
				'dependency'  => array(
					'show' => array(
	...
	add_action( 'firstframe_core_action_after_header_options_map', 'firstframe_core_add_standard_header_options', 10, 2 );
}
