...
if ( ! function_exists( 'firstframe_core_add_h1_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function firstframe_core_add_h1_typography_options( $page ) {
		...
		if ( $page ) {
			$h1_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h1',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H1 Typography', 'firstframe-core' ),
					'description' => esc_html__( 'Set values for Heading 1 HTML element', 'firstframe-core' ),
				)
			);
	...
	add_action( 'firstframe_core_action_after_typography_options_map', 'firstframe_core_add_h1_typography_options' );
}
