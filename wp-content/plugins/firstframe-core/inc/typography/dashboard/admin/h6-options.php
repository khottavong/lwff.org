...
if ( ! function_exists( 'firstframe_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function firstframe_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'firstframe-core' ),
					'description' => esc_html__( 'Set values for Heading 6 HTML element', 'firstframe-core' ),
				)
			);
			...
			$h6_1366_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1366 Typography', 'firstframe-core' ),
				)
			);
			...
			$h6_1024_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1024 Typography', 'firstframe-core' ),
				)
			);
			...
			$h6_768_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 768 Typography', 'firstframe-core' ),
				)
			);
			...
			$h6_680_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 680 Typography', 'firstframe-core' ),
				)
			);
	...
	add_action( 'firstframe_core_action_after_typography_options_map', 'firstframe_core_add_h6_typography_options' );
}
