...
if ( ! function_exists( 'firstframe_core_add_link_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function firstframe_core_add_link_typography_options( $page ) {
		...
		if ( $page ) {
			$link_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-link',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Link Typography', 'firstframe-core' ),
					'description' => esc_html__( 'Set values for link', 'firstframe-core' ),
				)
			);
	...
	add_action( 'firstframe_core_action_after_typography_options_map', 'firstframe_core_add_link_typography_options' );
}
