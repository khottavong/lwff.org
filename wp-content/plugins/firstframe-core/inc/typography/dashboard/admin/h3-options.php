...
if ( ! function_exists( 'firstframe_core_add_h3_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function firstframe_core_add_h3_typography_options( $page ) {
		...
		if ( $page ) {
			$h3_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h3',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H3 Typography', 'firstframe-core' ),
					'description' => esc_html__( 'Set values for Heading 3 HTML element', 'firstframe-core' ),
				)
			);
	...
	add_action( 'firstframe_core_action_after_typography_options_map', 'firstframe_core_add_h3_typography_options' );
}
