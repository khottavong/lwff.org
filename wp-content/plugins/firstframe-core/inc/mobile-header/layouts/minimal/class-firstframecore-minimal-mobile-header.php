...
class FirstFrameCore_Minimal_Mobile_Header extends FirstFrameCore_Mobile_Header {
	...
	public function __construct() {
		...
		add_filter( 'firstframe_core_filter_available_mobile_header_logo_images', array( $this, 'set_logo_image' ) );

		parent::__construct();
	}

	/**
	 * @return FirstFrameCore_Minimal_Mobile_Header
	 */
