...
if ( ! function_exists( 'firstframe_core_add_elegant_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function firstframe_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'FirstFrameCore_Elegant_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'firstframe_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class FirstFrameCore_Elegant_Icons_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return FIRSTFRAME_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
		...
		function specific_icons() {
			return apply_filters(
				'firstframe_core_filter_elegant_specific_icons',
				array(
					'search'        => 'icon_search',
