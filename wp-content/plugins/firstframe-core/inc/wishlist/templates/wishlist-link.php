...
<div class="qodef-wishlist qodef-m">
	<a class="qodef-m-link <?php echo esc_attr( $wishlist_class ); ?>" href="#" data-id="<?php the_ID(); ?>">
		<?php
		if ( $enable_title ) {
			$wishlist_title       = esc_html__( 'Add to wishlist', 'firstframe-core' );
			$wishlist_added_title = esc_html__( 'Added into wishlist', 'firstframe-core' );
			?>
		...
		<?php } ?>
		<?php echo firstframe_core_get_svg_icon( 'heart' ); ?>
	</a>
